...
var _chart_dataJson = require('./chart_data.json');
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
var _chart_dataJsonDefault = _parcelHelpers.interopDefault(_chart_dataJson);
const toChart = _chart.chart(document.getElementById("chart"), _chart_dataJsonDefault.default[4]);
toChart.init();

},{"./styles.scss":"1ApLC","./data":"4AbXi","./chart":"1b3aX","./chart_data.json":"4IxDj","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1ApLC":[function() {},{}],"4AbXi":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
function chart(root, data) {
  ...
  */
  ...
  function paint() {
    ...
    const [yMin, yMax] = _utils.computeBounderies({
      columns,
      types: data.types
    });
    // if (!prevMax) {
    ...
    yData.map(_utils.toCoords(xRatio, yRatio, DPI_HEIGHT, yMin, PADDING)).forEach((coords, indx) => {
...
function toCoords(xRatio, yRatio, DPI_HEIGHT, yMin, PADDING = 0) {
  return col => col.filter((_, i) => i !== 0).map((y, i) => [Math.floor(i * xRatio), Math.floor(DPI_HEIGHT - PADDING - (y - yMin) / yRatio)]);
}
...
function sliderChart(root, data, DPI_WIDTH) {
  ...
  const xRatio = _utils.computeXRatio(VIEW_WIDTH, data.columns[0].length);
  const yRatio = _utils.computeYRatio(VIEW_HEIGHT, yMax, yMin);
  ...
  // yAxis(yMin, yMax)
  // xAxis(xData, yData, xRatio)
  yData.map(_utils.toCoords(xRatio, yRatio, DPI_HEIGHT, yMin, -5)).forEach((coords, indx) => {
    const name = yData[indx][0];
    const color = data.colors[name];
    _utils.line(ctx, coords, {
      color
...
},{"./utils":"3EQWo","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"4IxDj":[function(require,module,exports) {
...
},{}]},["12yWF","5XPnV"], "5XPnV", "parcelRequireb826")
